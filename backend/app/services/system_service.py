...
class SystemService:
    ...
    def get_system_info(self) -> SystemInfo:
        ...
        try:
            ...
            return SystemInfo(
                cpu_count=4, memory_gb=8.0, platform="unknown", architecture="unknown"
            )
    ...
    def get_model_recommendations(self, system_info: SystemInfo) -> List[ModelInfo]:
        ...
        if memory_gb < 4:
            # Low memory systems
            recommended_names = ["llama3.2:1b"]
        elif memory_gb < 8:
            # Medium memory systems - prioritize dolphin-mistral:7b
            recommended_names = ["dolphin-mistral:7b", "llama3.2:3b"]
        elif memory_gb < 16:
            # High memory systems - prioritize dolphin-mistral:7b
            recommended_names = ["dolphin-mistral:7b", "llama3.2:8b"]
        else:
            # Workstation systems - prioritize dolphin-mistral:7b
            recommended_names = ["dolphin-mistral:7b", "llama3.2:8b"]
