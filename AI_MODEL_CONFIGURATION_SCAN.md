...
- `model.DECISION_MODEL` - Configurable model for quick decisions
...
5. **DECISION_MODEL** - For making quick decisions about web search necessity
...
- **WebSearchService**: Updated to use `settings.DECISION_MODEL`
